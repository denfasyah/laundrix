...
const navItems = [
  { name: 'Dasbor', href: '/owner/dashboard', icon: LayoutDashboard },
  { name: 'Transaksi', href: '/owner/transactions', icon: ReceiptText },
  { name: 'Cabang', href: '/owner/branches', icon: Store },
  { name: 'Karyawan', href: '/owner/employees', icon: Users },
  { name: 'Inventaris', href: '/owner/inventory', icon: Package },
  { name: 'Absensi', href: '/owner/attendance', icon: CalendarClock },
  { name: 'Laporan Mesin', href: '/owner/machine-reports', icon: Wrench },
  { name: 'Pengumuman', href: '/owner/announcements', icon: Megaphone },
];

export function OwnerSidebar({ isOpen = false, onClose }: { isOpen?: boolean; onClose?: () => void }) {
      ...
      <div className="pt-4 border-t border-white/10 mt-4">
        ...
        <div className="mt-4 flex items-center gap-2 px-1">
          <img 
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuDmGIsUYX9nPIhMWB7DfUhyz-wPdZuZMBpsIz9PpLv8LZUsKu6yM7tq1RswDdXRw56IZ0o3kaBPrH0gCZAjvlmma2O-dgBKRr_SIpatI9Ew6q9bWBjtHJr4yp_U0NLvoD1iyLI-ug-W0PzjWCqAolGCv0nOZf_blVN3_GkyLgimin4b0DprwqyRM4KaIuwH8SKCT7TtPbQOw77v8VGPL0CqzcAt4nvPjcGZeA7_uMsmMGxi51qPm9N_wDIXCficm8Hsxp9UB58CXR8" 
          />
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-semibold truncate leading-tight">Adent Gans</p>
            <p className="text-[11px] text-white/80 truncate leading-tight">Owner</p>
          </div>
